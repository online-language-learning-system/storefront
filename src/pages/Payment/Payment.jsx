...
return ( <div className="flex flex-col min-h-screen bg-[#fcc7e7]">
{/* Nội dung chính */} <div className="flex-1 pt-24 pb-8 px-4"> <div className="max-w-7xl mx-auto px-8">
{/* Header */} <div className="text-center mb-8"> <h1 className="text-3xl font-bold bg-gradient-to-r from-[#910c4e] to-[#b91c5a] bg-clip-text text-transparent mb-2">
Thanh toán </h1> <p className="text-gray-700 text-lg">Hoàn tất đơn hàng của bạn</p> </div>
            ...
            {cart.length === 0 ? (
              ...
              <div className="space-y-4">
                {cart.map((item, index) => (
                  <div
                    key={item.id}
                    className={`flex items-center justify-between p-4 border-2 rounded-3xl transition-all duration-200 ${
                      selectedItems.includes(item.id)
